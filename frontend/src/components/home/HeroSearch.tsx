    ...
    return (
        <section className="relative z-20 mb-10 pt-8 md:mb-14 md:pt-14">
            ...
            <div className="mx-auto max-w-5xl px-4 sm:px-6">
                <div className="overflow-visible rounded-4xl border border-slate-300 bg-slate-50/95 px-5 py-8 shadow-[0_28px_70px_-42px_rgba(15,23,42,0.44)] backdrop-blur transition-colors duration-300 dark:border-slate-700 dark:bg-slate-900/86 dark:shadow-[0_32px_90px_-42px_rgba(0,0,0,0.9)] sm:px-8 md:px-10 md:py-10">
