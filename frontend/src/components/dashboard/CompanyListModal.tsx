...
export const CompanyListModal = ({
    ...
    return (
        ...
        >
            <div
                className="absolute inset-2 sm:inset-4 mx-auto max-w-4xl bg-white rounded-lg sm:rounded-xl shadow-2xl flex flex-col overflow-hidden"
                                ...
                                <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-100">
                                    ...
                                    <div className="flex gap-2">
                                        <button
                                            ...
                                            disabled={page === 1}
                                            className="p-2.5 sm:p-2 rounded-lg border border-gray-200 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
                                        >
