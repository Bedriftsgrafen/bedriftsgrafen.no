...
export function BankruptciesSection({ 
  ...
  return (
    <div className="mt-10 md:mt-16">
      <section 
        className="bg-white rounded-2xl md:rounded-[2.5rem] p-6 md:p-12 border border-slate-100 shadow-sm relative overflow-hidden"
        aria-labelledby="bankruptcies-title"
      >
        <h3 
          id="bankruptcies-title"
          className="text-xl md:text-2xl font-black text-slate-900 mb-6 md:mb-10 flex items-center justify-between"
        >
            ...
            companies.map(company => (
              <li key={company.orgnr}>
                <Link
                  ...
                  className="flex items-center justify-between p-4 md:p-6 bg-slate-50 hover:bg-white border border-transparent hover:border-slate-200 rounded-xl md:rounded-2xl transition-all group focus-visible:ring-2 focus-visible:ring-rose-600 outline-none hover:scale-[1.02]"
        ...
        <Link
          to="/konkurser"
          search={searchParam}
          className="flex items-center justify-center gap-3 p-4 md:p-6 text-slate-500 font-black uppercase text-xs tracking-widest hover:text-rose-600 transition-all mt-6 md:mt-10 bg-slate-50 rounded-2xl md:rounded-3xl border border-dashed border-slate-200 hover:bg-rose-50/50 hover:border-rose-200 focus-visible:ring-2 focus-visible:ring-rose-600 outline-none"
        >
