...
export function Footer() {
  return (
    <footer className="bg-gray-900 text-gray-300 mt-16 pb-[env(safe-area-inset-bottom)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <a
              ...
              className="text-sm text-gray-400 hover:text-blue-400 flex items-center gap-2 mt-4 py-1.5"
            >
