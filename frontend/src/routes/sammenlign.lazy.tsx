        ...
        <div className={`bg-white rounded-2xl border ${battleMode && Object.values(isWinner).some(Boolean) ? 'border-blue-200 shadow-md' : 'border-slate-200 shadow-sm'} p-6 space-y-5 relative transition-all duration-300 min-w-0`}>
            ...
            {!item.company && item.loading ? (
                <div className="flex flex-col items-center justify-center py-12 space-y-4">
                    <Building2 className="h-8 w-8 text-slate-200 animate-pulse" aria-hidden="true" />
                ...
                <>
                    ...
                    <div className="space-y-4 min-w-0">
                        <div className="flex items-start gap-2 text-sm min-w-0">
                            <Building2 className="h-4 w-4 text-slate-300 shrink-0 mt-0.5" aria-hidden="true" />
                        ...
                        <div className="space-y-1.5">
                            <div className="flex items-center justify-between gap-1.5 min-w-0">
                                <div className="flex items-center gap-2 text-slate-500 min-w-0">
                                    <Users className="h-4 w-4 text-slate-300 shrink-0" aria-hidden="true" />
            ...
            <div className="max-w-7xl mx-auto px-4 pb-20">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                    <div className="flex items-center gap-6">
                        ...
                        >
                            <ArrowLeft className="h-5 w-5 text-slate-600 group-hover:-translate-x-1 transition-transform" aria-hidden="true" />
                        </Link>
                        <div>
                    ...
                    <div className="flex flex-col items-start gap-2 md:items-end">
                            ...
                            {orgNumbers.length > 1 && (
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-6 py-3 rounded-2xl font-bold text-sm transition-all shadow-sm border ${battleMode
                                        ? 'bg-blue-900 text-white border-blue-800 shadow-blue-200'
                        ...
                        <p className="min-h-5 text-sm font-medium text-slate-500" role="status" aria-live="polite">
                            ...
                            {data.map((item, idx) => (
                                <div key={item.orgnr} className="relative group min-w-0">
                                    ...
                                    {battleMode && idx < data.length - 1 && (
                                        <div className="hidden lg:flex absolute -right-4 top-1/2 -translate-y-1/2 z-20 items-center justify-center w-8 h-8 bg-blue-900 text-white rounded-full shadow-xl border-4 border-white pointer-events-none italic">
                    ...
                    <div className="mt-8 md:mt-12 p-5 md:p-8 bg-slate-100/50 border border-slate-200 rounded-2xl md:rounded-3xl flex flex-col sm:flex-row items-center justify-between gap-4 md:gap-6">
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-slate-500 font-medium">Aktiver duellvisning for å kåre vinnere og se relative forskjeller i nøkkeltall.</p>
                            </div>
                        </div>
                        <button
                            type="button"
