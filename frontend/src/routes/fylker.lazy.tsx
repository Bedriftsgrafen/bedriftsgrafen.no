          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
            {counties?.sort((a, b) => b.company_count - a.company_count).map(county => (
              <Link
                ...
                className="group bg-white rounded-2xl md:rounded-3xl p-6 md:p-10 border border-slate-200 hover:border-blue-200 shadow-sm hover:shadow-2xl hover:-translate-y-1.5 transition-all duration-500 flex flex-col justify-between relative overflow-hidden"
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-center justify-between mb-4 md:mb-8">
                    <div className="h-12 w-12 md:h-16 md:w-16 bg-slate-50/90 backdrop-blur-sm border border-slate-200/50 text-slate-400 rounded-xl md:rounded-2xl flex items-center justify-center group-hover:bg-blue-600 group-hover:text-white group-hover:border-blue-500 transition-all duration-300 shadow-sm">
                  ...
                  <h2 className="text-2xl md:text-3xl font-black text-slate-900 mb-3 group-hover:text-blue-700 transition-colors leading-tight tracking-tight drop-shadow-sm">
                    {county.name}
                  </h2>
