...
NACE_SECTIONS: dict[str, str] = {
    ...
    "E": "Vannforsyning, avløps-, renovasjons- og oppryddingsvirksomhet",
    "F": "Bygge- og anleggsvirksomhet",
    "G": "Varehandel",
    "H": "Transport og lagring",
    "I": "Overnattings- og serveringsvirksomhet",
    "J": "Utgivelse, kringkasting, innholdsproduksjon og distribusjonsvirksomhet",
    "K": "Telekommunikasjon, dataprogrammering, datainfrastruktur og informasjonsteknologi",
    ...
    "P": "Offentlig administrasjon og forsvar, trygdeordninger underlagt offentlig forvaltning",
    "Q": "Undervisning",
    "R": "Helse- og sosialtjenester",
    "S": "Kulturell virksomhet, idrett og fritidsaktiviteter",
    "T": "Annen tjenesteyting",
    "U": "Lønnet arbeid i private husholdninger og annen produksjon til eget bruk",
    "V": "Aktiviteter i internasjonale organisasjoner og organer",
}
...
NACE_DIVISIONS: dict[str, str] = {
    ...
    "98": "Annen vareproduksjon og tjenesteyting i private husholdninger til eget bruk",
...
def get_nace_name(nace_code: str) -> str:
    ...
    Handles NACE sections (A-V), division codes (2 digits),
