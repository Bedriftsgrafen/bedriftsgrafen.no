...
async def test_get_municipality_dashboard(mock_stats_service):
    # Arrange
    mock_stats_service.get_municipality_premium_dashboard = AsyncMock(return_value={
        "code": "0301",
        "name": "Oslo",
        "county_code": "03",
        "county_name": "Oslo",
...
async def test_get_municipality_not_found(mock_stats_service):
    # Arrange
    mock_stats_service.get_municipality_premium_dashboard = AsyncMock(return_value={"population": 0, "company_count": 0})
