...
async def test_fetch_subunit_updates_success(update_service, mock_db):
    ...
    mock_response.json.return_value = {
        "_embedded": {"oppdaterteUnderenheter": [{"organisasjonsnummer": "999888777", "oppdateringsid": 100}]},
        "_links": {"next": None},
    }
...
async def test_fetch_subunit_updates_handles_410(update_service, mock_db):
    ...
    mock_response.status_code = 200
    mock_response.json.return_value = {
        "_embedded": {"oppdaterteUnderenheter": [{"organisasjonsnummer": "GONE123", "oppdateringsid": 200}]},
        "_links": {"next": None},
    }
