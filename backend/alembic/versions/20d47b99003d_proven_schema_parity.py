...
def upgrade() -> None:
    ...
    op.drop_index(
        op.f("idx_bedrifter_active_orgform"),
        table_name="bedrifter",
        postgresql_where="((konkurs IS NOT TRUE) AND (under_avvikling IS NOT TRUE) AND (under_tvangsavvikling IS NOT TRUE))",
    )
    ...
    op.drop_index(
        op.f("idx_bedrifter_konkursdato"), table_name="bedrifter", postgresql_where="(konkursdato IS NOT NULL)"
    )
    op.drop_index(op.f("idx_bedrifter_last_polled_regnskap"), table_name="bedrifter")
    op.drop_index(
        op.f("idx_bedrifter_list_covering"),
        table_name="bedrifter",
        postgresql_include=["orgnr", "organisasjonsform", "naeringskode", "antall_ansatte", "stiftelsesdato"],
    )
    op.drop_index(
        op.f("idx_bedrifter_nace_ansatte"), table_name="bedrifter", postgresql_ops={"naeringskode": "text_pattern_ops"}
    )
    op.drop_index(op.f("idx_bedrifter_nace_founded"), table_name="bedrifter")
    op.drop_index(
        op.f("idx_bedrifter_nace_kommune"), table_name="bedrifter", postgresql_ops={"naeringskode": "text_pattern_ops"}
    )
    op.drop_index(op.f("idx_bedrifter_naeringskode"), table_name="bedrifter")
    op.drop_index(
        op.f("idx_bedrifter_naeringskode_pattern"),
        table_name="bedrifter",
        postgresql_ops={"naeringskode": "text_pattern_ops"},
    )
    op.drop_index(
        op.f("idx_bedrifter_naeringskode_prefix"),
        table_name="bedrifter",
        postgresql_ops={"naeringskode": "text_pattern_ops"},
    )
    ...
    op.drop_index(
        op.f("idx_bedrifter_orgform_json"), table_name="bedrifter", postgresql_where="(organisasjonsform IS NULL)"
    )
    ...
    op.drop_index(
        op.f("idx_bedrifter_orgnr_pattern"), table_name="bedrifter", postgresql_ops={"orgnr": "text_pattern_ops"}
    )
    ...
    op.drop_index(
        op.f("idx_list_orgform_ansatte"),
        table_name="bedrifter",
        postgresql_where="((konkurs IS NOT TRUE) AND (under_avvikling IS NOT TRUE) AND (under_tvangsavvikling IS NOT TRUE))",
    )
    op.drop_index(
        op.f("idx_similar_optimal"),
        table_name="bedrifter",
        postgresql_where="((konkurs = false) AND (under_avvikling = false) AND (under_tvangsavvikling = false))",
    )
    op.drop_index(
        op.f("idx_similar_postnummer"),
        table_name="bedrifter",
        postgresql_where="((konkurs = false) AND (under_avvikling = false) AND (under_tvangsavvikling = false))",
    )
    op.create_index(
        ...
        "bedrifter",
        [sa.literal_column("left(forretningsadresse ->> 'kommunenummer', 4)")],
        unique=False,
    )
    ...
    op.drop_index(
        op.f("idx_regnskap_ebitda_margin"), table_name="regnskap", postgresql_where="(ebitda_margin IS NOT NULL)"
    )
    op.drop_index(op.f("idx_regnskap_egenkapital"), table_name="regnskap")
    op.drop_index(
        op.f("idx_regnskap_egenkapitalandel"), table_name="regnskap", postgresql_where="(egenkapitalandel IS NOT NULL)"
    )
    op.drop_index(
        op.f("idx_regnskap_likviditetsgrad1"), table_name="regnskap", postgresql_where="(likviditetsgrad1 IS NOT NULL)"
    )
    ...
    op.alter_column("underenheter", "navn", existing_type=sa.TEXT(), type_=sa.String(), existing_nullable=True)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(None, "underenheter", type_="foreignkey")  # type: ignore[arg-type]
    op.create_foreign_key(
        op.f("underenheter_parent_orgnr_fkey"),
        "underenheter",
        "bedrifter",
        ["parent_orgnr"],
        ["orgnr"],
    ...
    op.alter_column("underenheter", "navn", existing_type=sa.String(), type_=sa.TEXT(), existing_nullable=True)
    op.alter_column("underenheter", "parent_orgnr", existing_type=sa.VARCHAR(), nullable=False)
    op.drop_constraint(None, "roller", type_="foreignkey")  # type: ignore[arg-type]
    ...
    op.drop_constraint(None, "regnskap", type_="foreignkey")  # type: ignore[arg-type]
    ...
    op.create_unique_constraint(
        op.f("uq_regnskap_orgnr_aar"), "regnskap", ["orgnr", "aar"], postgresql_nulls_not_distinct=False
    )
    ...
    op.create_index(
        op.f("idx_regnskap_likviditetsgrad1"),
        "regnskap",
        ["likviditetsgrad1"],
        unique=False,
        postgresql_where="(likviditetsgrad1 IS NOT NULL)",
    )
    op.create_index(
        op.f("idx_regnskap_egenkapitalandel"),
        "regnskap",
        ["egenkapitalandel"],
        unique=False,
        postgresql_where="(egenkapitalandel IS NOT NULL)",
    )
    op.create_index(op.f("idx_regnskap_egenkapital"), "regnskap", ["egenkapital"], unique=False)
    op.create_index(
        op.f("idx_regnskap_ebitda_margin"),
        "regnskap",
        ["ebitda_margin"],
        unique=False,
        postgresql_where="(ebitda_margin IS NOT NULL)",
    )
    ...
    op.create_index(
        op.f("idx_municipality_population_year_code"),
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            autoincrement=False,
            nullable=True,
            comment="JSONB storage for complete raw company data from Enhetsregisteret",
        ),
    )
    op.add_column(
        "bedrifter",
    ...
    op.create_index(
        ...
        [
            "naeringskode",
            sa.literal_column("(forretningsadresse ->> 'postnummer'::text)"),
            sa.literal_column("antall_ansatte DESC NULLS LAST"),
        ],
        unique=False,
        postgresql_where="((konkurs = false) AND (under_avvikling = false) AND (under_tvangsavvikling = false))",
    )
    op.create_index(
        ...
        "bedrifter",
        [
            sa.literal_column('"left"(naeringskode::text, 3)'),
            sa.literal_column("upper(forretningsadresse ->> 'kommune'::text)"),
            sa.literal_column("antall_ansatte DESC NULLS LAST"),
        ],
        unique=False,
        postgresql_where="((konkurs = false) AND (under_avvikling = false) AND (under_tvangsavvikling = false))",
    ...
    op.create_index(
        op.f("idx_list_orgform_ansatte"),
        "bedrifter",
        ["organisasjonsform", sa.literal_column("antall_ansatte DESC")],
        unique=False,
        postgresql_where="((konkurs IS NOT TRUE) AND (under_avvikling IS NOT TRUE) AND (under_tvangsavvikling IS NOT TRUE))",
    )
    op.create_index(
        op.f("idx_companies_geocoding_queue"),
        "bedrifter",
        [sa.literal_column("antall_ansatte DESC NULLS LAST")],
        unique=False,
        postgresql_where="(latitude IS NULL)",
    )
    ...
    op.create_index(
        op.f("idx_bedrifter_orgnr_pattern"),
        "bedrifter",
        ["orgnr"],
        unique=False,
        postgresql_ops={"orgnr": "text_pattern_ops"},
    )
    op.create_index(
        op.f("idx_bedrifter_orgform_stiftelse_desc"),
        "bedrifter",
        ["organisasjonsform", sa.literal_column("stiftelsesdato DESC NULLS LAST")],
        unique=False,
    )
    op.create_index(
        op.f("idx_bedrifter_orgform_orgnr_desc"),
        "bedrifter",
        ["organisasjonsform", sa.literal_column("orgnr DESC")],
        unique=False,
    )
    op.create_index(op.f("idx_bedrifter_orgform_orgnr_asc"), "bedrifter", ["organisasjonsform", "orgnr"], unique=False)
    op.create_index(
        op.f("idx_bedrifter_orgform_navn_desc"),
        "bedrifter",
        ["organisasjonsform", sa.literal_column("navn DESC")],
        unique=False,
    )
    op.create_index(op.f("idx_bedrifter_orgform_navn_asc"), "bedrifter", ["organisasjonsform", "navn"], unique=False)
    op.create_index(
        op.f("idx_bedrifter_orgform_nace"), "bedrifter", ["organisasjonsform", "naeringskode"], unique=False
    )
    op.create_index(
        op.f("idx_bedrifter_orgform_json"),
        "bedrifter",
        [sa.literal_column("((data -> 'organisasjonsform'::text) ->> 'kode'::text)")],
        unique=False,
        postgresql_where="(organisasjonsform IS NULL)",
    )
    op.create_index(
        op.f("idx_bedrifter_orgform_ansatte_desc"),
        "bedrifter",
        ["organisasjonsform", sa.literal_column("antall_ansatte DESC NULLS LAST")],
        unique=False,
    )
    op.create_index(
        op.f("idx_bedrifter_organisasjonsform_desc"),
        "bedrifter",
        [sa.literal_column("organisasjonsform DESC NULLS LAST")],
        unique=False,
    )
    ...
    op.create_index(
        op.f("idx_bedrifter_nace_kommune"),
        "bedrifter",
        ["naeringskode", sa.literal_column("(forretningsadresse ->> 'kommune'::text)")],
        unique=False,
        postgresql_ops={"naeringskode": "text_pattern_ops"},
    )
    op.create_index(
        op.f("idx_bedrifter_nace_founded"),
        "bedrifter",
        ["naeringskode", sa.literal_column("stiftelsesdato DESC NULLS LAST")],
        unique=False,
    )
    op.create_index(
        op.f("idx_bedrifter_nace_ansatte"),
        "bedrifter",
        ["naeringskode", sa.literal_column("antall_ansatte DESC NULLS LAST")],
        unique=False,
        postgresql_ops={"naeringskode": "text_pattern_ops"},
    )
    op.create_index(
    ...
    op.create_index(
        op.f("idx_bedrifter_konkursdato"),
        "bedrifter",
        [sa.literal_column("konkursdato DESC NULLS LAST")],
        unique=False,
        postgresql_where="(konkursdato IS NOT NULL)",
    )
    op.create_index(
        op.f("idx_bedrifter_konkurs"), "bedrifter", ["konkurs"], unique=False, postgresql_where="(konkurs = true)"
    )
    op.create_index(
        op.f("idx_bedrifter_kommune"),
        "bedrifter",
        [sa.literal_column("(forretningsadresse ->> 'kommune'::text)")],
        unique=False,
    )
    ...
    op.create_index(
        op.f("bedrifter_search_vector_idx"), "bedrifter", ["search_vector"], unique=False, postgresql_using="gin"
    )
    op.alter_column(
        "bedrifter",
        "created_at",
